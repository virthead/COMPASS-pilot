...
#    ERR_USERKILL = 1205 # not used by pilot
    ...
    ERR_TEHOSTNAME = 1233
    ERR_AFATALERRORAPPEARED = 1235
    ERR_COREDUMPED = 1236
    ERR_NOEVENTS = 1237
    ERR_ABNORMALJOBTERMINATION = 1238
    ERR_ABORTED = 1239
    ERR_NOENDOFJOB = 1240
    ERR_CANNOTALLOCATE = 1241
    ERR_EMPTYSTRING = 1243
    ...
    pilotError = {
        ...
        ERR_AFATALERRORAPPEARED: "A fatal error appeared",
        ERR_COREDUMPED: "(core dumped) $CORAL/../phast/coral/coral.exe",
        ERR_NOEVENTS: "char* exception: DaqEventsManager::GetEvent(): no event",
        ERR_ABNORMALJOBTERMINATION: "Abnormal job termination. Exception #2 had been caught",
        ERR_ABORTED: "Aborted ",
        ERR_NOENDOFJOB: "No End of Job message found in stdout",
        ERR_CANNOTALLOCATE: "TLattice::TLattice: Cannot Allocate N Bytes in Memory!",
